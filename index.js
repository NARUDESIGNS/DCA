...
setInterval(() => {
    carouselImage.style.backgroundImage = `url(./assets/images/carousel-slide-${randomFromRange(1, 10)}.jpeg)`;
}, 3500);
...
(async function () {
    const response = await fetch('./json/upcomingEvent.json?v=321');
